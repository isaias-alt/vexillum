...
// it stranded as Blocked forever: internal/sentinel.tickProject never polls
// a Blocked task, so nothing else would ever catch this. The caller should
// point the general at 'vexillum redispatch' instead.

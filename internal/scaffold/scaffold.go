...
// Template is the commander rules content vexillum writes to
// .claude/rules/vexillum.md (or ~/.claude/rules/vexillum.md with
// --global).
const Template = `# Vexillum commander rules
...
func RecordHash(configDir string, updated bool) error {
	...
	cfg.VexillumRuleHash = hashContent(Template)
